...
public class Constants {
    ...
    public static final String TEXT = "Berners-Lee's vision of a global hyperlinked information system became a possibility by the second half of the 1980s. " +
            ...
            "client–server architecture.[9] At this point HTML and HTTP had already been in development for about two months and the first Web server was about a month " +
